<script lang="ts">
	...
	let { nextStep }: StepProps = $props();
</script>

<div class="max-w-4xl mx-auto">
	<!-- Welcome Section -->
	<div class="text-center mb-8">
		<h3 class="text-2xl font-bold text-gray-900 mb-4">Welcome to the SO-101 Setup Wizard</h3>
	...
	<div class="mb-8">
		...
		<div class="grid md:grid-cols-2 gap-6">
			<div class="bg-blue-50 p-6 rounded-lg">
				<h5 class="font-semibold text-blue-900 mb-3">Motor Configuration</h5>
				<ul class="text-blue-800 space-y-2 text-sm">
					<li>• Configure servo IDs for all 6 motors</li>
					<li>• Set proper communication parameters</li>
					<li>• Verify motor connectivity and operation</li>
				</ul>
			</div>
			
			<div class="bg-green-50 p-6 rounded-lg">
				<h5 class="font-semibold text-green-900 mb-3">Calibration Process</h5>
				<ul class="text-green-800 space-y-2 text-sm">
					<li>• Set homing positions for each joint</li>
					<li>• Record full range of motion limits</li>
					<li>• Save calibration data to servo memory</li>
				</ul>
			</div>
		</div>
	</div>
